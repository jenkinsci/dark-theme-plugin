...
//    '''
    loginThemeConfig.head = '''
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/oleg-nenashev/dark-theme@dark-login/login-theme/simple-page.css" type="text/css" />
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/oleg-nenashev/dark-theme@dark-login/login-theme/simple-page.theme.css" type="text/css" />
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/oleg-nenashev/dark-theme@dark-login/login-theme/simple-page-forms.css" type="text/css" />
    '''
} else {
    loginThemeConfig.head = '''
